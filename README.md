...
여기에 더해 **원문 축자 청크 2,008개**가 색인되어 있습니다 — 15개 소스 중 **13개**:
10 CFR 50.150, RG 1.217, NEI 07-13, 체코 원자력법 263/2016 · 설계 시행령 329/2017 ·
부지 시행령 378/2016, Euratom 지침 2014/87, WENRA SRL 2020,
IAEA SSG-68 · SSG-79 · SSR-2/1 · SRS-86 · SRS-87.
미색인은 EUR(유료)과 IAEA SRS-88 둘뿐입니다.
...
확보했습니다. 남은 미확보 문서는 **EUR Volume 2**(라이선스 필요)와 **IAEA SRS No. 88** 둘뿐입니다.
...
2. **CW-08 — 국부손상 경험식은 "같은 식, 다른 지위"입니다(원문 대조 완료).**
   ...
   **카탈로그로 나열**만 하고 선택을 강제하지 않으며, 고체 발사체 기반이므로
   ...
   주경로로 둡니다.
3. **CW-05 — 체코는 단일 기준이 아니라 2단 구조입니다.** § 12는 일반 기본
...
4. **체코는 임계값이 아니라 '루프'입니다.** 부지 시행령 378/2016 § 13은 *설계가 상정한
...
5. **CW-03 / CW-07 — 위협 수치의 정량 비교는 여전히 불가능합니다(원문으로 확인).**
